...
if ($resultado->num_rows > 0) {
    ...
    <body>
        ...
        <div class = "panel-box">
        <form action="2tabla_estudiante.php" method="POST">
            <h2>Asignacion de equipos</h2>
            <br>
            <br>
            <div class="rol">
    ...
    <input class="btno" type="submit" name="editar"  value="Asignar Equipo">
...
$conexion->close();
?>
<a class ="custom-button4" href="verificarpeticiones.php">Volver atras</a>
