...
<?php
        ...
        $rol_b = "Profesor";
        $sql = "SELECT i.nombre_persona, i.nom_inventario, i.estado, i.fecha_entrega, i.hora_entrega, i.fecha_regreso, i.hora_regreso FROM inventario as i LEFT JOIN usuarios as e ON i.nombre_persona = e.nombre WHERE i.nombre_persona = '$nombre' AND e.rol = '$rol_b'";
        ...
        if ($resultado->num_rows > 0) {
            ...
            echo"<h2 align='center'>Equipos prestados</h2>";
            echo "</div>";
        ...
        <th style=width:150px;>Hora de entrega</th>
        <th style=width:150px;>Fecha de regreso</th>
        <th style=width:150px;>Hora de regreso</th>
        </tr>";
