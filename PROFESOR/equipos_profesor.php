...
<?php
        ...
        $sql = ( "SELECT * FROM usuarios as i INNER JOIN peticiones_profesores as e ON i.nombre = e.pide WHERE e.pide = '$nombre' LIMIT $offset, $registrosPorPagina");
        $resultado = $conexion->query($sql);
        
        // Consulta SQL para obtener el número total de registros
        $totalRegistros = $conexion->query("SELECT COUNT(*) as total FROM usuarios as i INNER JOIN peticiones_profesores as e ON i.nombre = e.pide WHERE e.pide = '$nombre'")->fetch_assoc()['total'];
