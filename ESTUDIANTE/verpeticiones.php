...
<STYle>
        html{
            background: linear-gradient(white,60%,#FADBD8 );height:790px;
...
<?php
        ...
        <th style=width:150px;Equipo que pide</th>
        <th style=width:100px;>Estado</th>
        <th style=width:150px;>Fecha de prestamo</th>
        <th style=width:150px;>Estado del prestamo</th>
        </tr>";
        ...
        echo "</table>";
            ...
            echo "<table border='1'>";
            echo "<th >Estudiante</th><th style=width:150px;>Nombre del equipo</th><th style=width:100px;>Estado</th><th style=width:150px;>Fecha de prestamo</th><th style=width:150px;>Fecha de devolucion</th></tr>";
            echo "<br>";
